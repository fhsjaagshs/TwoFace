...
- (NSDictionary *)dictionaryValue {
    return [NSDictionary dictionaryWithObjects:[NSArray arrayWithObjects:[_from dictionaryValue], [_to dictionaryValue], _identifier, _message, [NSString stringWithFormat:@"%f",[_createdAt timeIntervalSince1970]-1800], _type, _url, _subject, _name, _thumbnailURL, _link, _pictureURL, _comments, _actionsAvailable, _objectIdentifier, nil] forKeys:[NSArray arrayWithObjects:@"from", @"to", @"id", @"message", @"updated_time", @"type", @"url", @"subject", @"name", @"picture", @"link", @"embed_html_parsed", @"comments", @"actions_are_available", @"object_id", nil]];
}
