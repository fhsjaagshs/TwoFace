        ...
        if ([action isEqualToString:kApprequests]) {        
            ...
            if (fbid != nil) {
              ...
              //  id fbids = [parser objectWithString:fbid];
                id fbids = [NSJSONSerialization JSONObjectWithData:[fbid dataUsingEncoding:NSUTF8StringEncoding allowLossyConversion:NO] options:NSJSONReadingMutableContainers error:nil];
